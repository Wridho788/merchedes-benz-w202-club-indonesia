        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              >
                <button className="inline-flex items-center justify-center gap-2 bg-white hover:bg-gray-100 text-brand-primary px-8 py-3 rounded-lg font-semibold transition-colors">
                  <svg
              ...
              {/** Use chapter phone if available, otherwise fallback to linktr.ee */}
              {
                (() => {
                  ...
                  const waHref = phone ? `https://wa.me/${phone}` : "https://linktr.ee/mbw202cijakartaregion";
                  return (
                    <a
                      href={waHref}
                      target="_blank"
